...
exports.misteri = void 0;
exports.calcolaMisteroOggi = calcolaMisteroOggi;
exports.calcolaMisteroDomani = calcolaMisteroDomani;
exports.misteri = [
...
function calcolaMisteroOggi(numeroPartecipante) {
    const oggi = new Date();
    ...
    if (posizione < 0)
        posizione += 20;
    return exports.misteri[posizione];
}
function calcolaMisteroDomani(numeroPartecipante) {
